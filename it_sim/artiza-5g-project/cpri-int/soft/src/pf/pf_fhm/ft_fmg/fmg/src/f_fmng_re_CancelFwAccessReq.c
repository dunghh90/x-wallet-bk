/*!
 * @skip  $ld:$
 * @file  f_fmng_re_CancelFwAccessReq.c
...
VOID f_fmng_re_CancelFwAccessReq( VOID *pRcvMsg )
{
	cmn_com_assert_th_get(f_fmngw_assert_p, D_RRH_LOG_AST_LV_ENTER, "[f_fmng_re_CancelFwAccessReq] ENTER" );				
	...
	switch(f_fmngw_re_apikind)
	{
		case D_FMNG_API_WRT:
			...
			f_fmngw_flashWaitEraReq_re.clearFlashRom[0].face = f_fmngw_flashWaitWrtReq_re.writeFlashRom[0].face;
			f_fmngw_flashWaitEraReq_re.clearFlashRom[0].offset = f_fmngw_flashWaitWrtReq_re.writeFlashRom[0].offset;
			f_fmngw_flashWaitEraReq_re.clearFlashRom[0].size = f_fmngw_flashWaitWrtReq_re.writeFlashRom[0].size;
		...
		case D_FMNG_API_RD:
			...
			/* READ CANCEL flag ON														*/
			/****************************************************************************/
			f_fmngw_read_cancel_re = D_SYS_ON;
			f_fmngw_re_thrdState = D_FMNG_THRDSTA_RE_FLSHRWCANCEL;
			break;
		default:
			break;
	...
	cmn_com_assert_th_get(f_fmngw_assert_p, D_RRH_LOG_AST_LV_RETURN, "[f_fmng_re_CancelFwAccessReq] RETURN" );
	return;
}
