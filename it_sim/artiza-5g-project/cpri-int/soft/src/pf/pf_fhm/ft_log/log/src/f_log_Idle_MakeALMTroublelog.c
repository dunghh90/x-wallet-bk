/*!
 * @skip		$ld:$
 * @file		f_log_Idle_MakeALMTroublelog.c
 ...
 * @date		2013/10/29 ALPHA)横山 Create
 */
INT f_log_Idle_MakeALMTroublelog(VOID* msgP)
{
	cmn_com_assert_th_get(f_logw_assert_p, D_RRH_LOG_AST_LV_ENTER, "[f_log_Idle_MakeALMTroublelog] ENTER" );
	
	/* 種別は中で判定する	*/
	f_log_makeTroubleLog( ((T_SYS_TROUBLE_LOG_OUTPUT_REQ *)msgP)->trouble_kind );
	
	cmn_com_assert_th_get(f_logw_assert_p, D_RRH_LOG_AST_LV_RETURN, "[f_log_Idle_MakeALMTroublelog] RETURN" );
