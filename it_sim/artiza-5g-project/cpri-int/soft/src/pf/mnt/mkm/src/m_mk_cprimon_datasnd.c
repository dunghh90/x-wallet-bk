 ...
 */
/********************************************************************************************************************/
VOID m_mk_CpriMon_DataSnd(UINT *inf_p)
{
    ...
    *(USHORT*)(mondat_p + 1) = mnt_com_swap_USHORT(*(USHORT*)(mondat_p + 1));
	...
	{
		cm_Assert(CMD_ASL_DBGLOW, CMD_NUM0, "[m_mk_CpriMon_DataSnd] Connect mode NG");
		return;
	}
	/* Monitor data receiving processing 	*/
	m_mk_cm_MonDatProc(MKD_CPRIMONDATSNDNTC, inf_p, link_num);
}
/* @} */
