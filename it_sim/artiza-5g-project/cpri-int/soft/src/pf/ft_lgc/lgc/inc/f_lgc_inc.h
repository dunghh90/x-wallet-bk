...
#include	"f_lgc_def.h"									/*!< 定数定義			*/
#include	"f_lgc_ext.h"									/*!< 外部参照宣言		*/
#include	"f_lgc_typ.h"									/*!< 構造体タグ宣言		*/
#include	"f_lgc_ftyp.h"									/*!< プロトタイプ宣言	*/
#include	"f_lgc_matrix.h"								/*!< マトリクス			*/
#include	"f_lgc_matrix_local.h"							/*!< 外部参照			*/
#include	"f_lgc_ram.h"									/*!< ramヘッダ			*/
#include	"f_lgc_ram_local.h"								/*!< ramヘッダローカル	*/
