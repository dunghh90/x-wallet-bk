/*!
 * @skip  $ld:$
 * @file  rrhApi_Rfa_Mqr_TrainingCal.c
 * @brief API : RF操作関連
...
/********************************************************************************************************************/
/**
 *  @brief  API :TxCal/RxCalトレーニング要求
 *  @note   PF EVENT ID           : 0xA0010009
 *          Reponse  ID : -
 *          TYPE        : MNT
 ...
 */
/********************************************************************************************************************/
E_RRHAPI_RCODE rrhApi_Rfa_Mqr_TrainingCal(INT qid, INT wtime, VOID *data_p,
												USHORT txrx_flag)
{
