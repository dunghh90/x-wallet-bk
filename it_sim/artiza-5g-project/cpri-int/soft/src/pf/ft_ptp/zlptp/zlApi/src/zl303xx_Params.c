...
zlStatusE zl303xx_CreateDeviceInstance(zl303xx_ParamsS **zl303xx_Params)
{
   ...
   if (status == ZL303XX_OK)
   {
      ...
      {
         status = zl303xx_Dpll72xStoreDeviceParam(*zl303xx_Params);
      }
   }
#endif
#if defined ZLS30771_INCLUDED
   if (status == ZL303XX_OK)
   {
      ...
      {
         status = zl303xx_Dpll77xStoreDeviceParam(*zl303xx_Params);
      }
   }
#endif
...
zlStatusE zl303xx_FreeDeviceInstance(zl303xx_ParamsS **zl303xx_Params)
{
   ...
   if (status == ZL303XX_OK)
   {
      if( zl303xx_GetDefaultDeviceType() == ZL3072X_DEVICETYPE )
      {
         status = zl303xx_Dpll72xRemoveDeviceParam(*zl303xx_Params);
      }
   }
#endif
#if defined ZLS30771_INCLUDED
   if (status == ZL303XX_OK)
   {
      if( zl303xx_GetDefaultDeviceType() == ZL3077X_DEVICETYPE )
      {
         status = zl303xx_Dpll77xRemoveDeviceParam(*zl303xx_Params);
      }
   }
#endif
