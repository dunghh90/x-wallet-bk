...
#define ZLS3077X_DPLL_MAX                           4        /* DPLL 0-3 */
#define ZLS3077X_REF_MAX                            10       /* ref 0-9 */
...
#define ZL303XX_MEM_SIZE_MASK_77X                     (Uint32T)0x0003F000
#define ZL303XX_MEM_SIZE_SHIFT_77X                    (Uint16T)12
...
#define ZL303XX_MEM_ADDR_AND_PAGE_MASK_77X            (Uint32T)0x00000FFF
...
#define ZL303XX_MEM_PAGE_MASK_77X                     (Uint32T)0x00000F80
...
#define ZL303XX_PAGED_ADDR_MIN_77X                    (Uint32T)0x00
#define ZL303XX_PAGED_ADDR_MAX_77X                    (Uint32T)0x7E
...
typedef enum {
    ...
    ZLS3077X_BW_112Hz    = 3,
    ZLS3077X_BW_244Hz    = 4,
    ZLS3077X_BW_488Hz_1  = 5,
    ZLS3077X_BW_488Hz_2  = 6,
...
#define ZLS3077X_MODE_ONLY_MASK                         (0x03)
#define ZLS3077X_REF_ONLY_MASK                          (0x07)

/* Dpll freq offset register when in NCO mode (6 bytes, high order byte) */
#define ZLS3077X_NCO_FREQ_OFFSET_WR_HI_DPLL(dpllId)     ZL303XX_MAKE_MEM_ADDR_77X((0x0300 + ((dpllId) * 0x20)), ZL303XX_MEM_SIZE_2_BYTE)
/* Dpll freq offset register when in NCO mode (5 bytes, low order bytes) */
#define ZLS3077X_NCO_FREQ_OFFSET_WR_LO_DPLL(dpllId)     ZL303XX_MAKE_MEM_ADDR_77X((0x0302 + ((dpllId) * 0x20)), ZL303XX_MEM_SIZE_4_BYTE)

/* Dpll delta frequency read request registers */
#define ZLS3077X_DPLL_DF_CTRL(dpllId)                   ZL303XX_MAKE_MEM_ADDR_77X(0x306 + ((dpllId) * 0x20), ZL303XX_MEM_SIZE_1_BYTE)
...
#define ZLS3077X_DPLL_PULL_IN_GET(dpllId)               ((data))
