...
/*******************************************************************************
  Function Name:  sockGetUuid

  Details:   Obtains a unique identifier for the specified transport link

  Parameters:
   [in]   pSktData    A data structure for a previously established and configured socket.

    [out]   uuid     A unique identifier for this stream interface. For PTP applications
...
Sint32T sockGetUuid(
   zl303xx_SocketDataS *pSktData,
   Uint8T (*uuid)[ZL303XX_UUID_NUM_BYTES]
   );
