...
*
*/
INT f_pfm_msi_recv_ind( VOID *msgP )
{
	UINT						w_messageId;
	UINT						w_requestId;
	...
	switch( w_messageId )
	{
		case D_MSG_MSI_O_RAN_PFM_MNG_EDIT_REQ :		/* o-ran-Perfomance Management EDIT要求	*/
			ret = f_pfm_o_ran_pfm_mgmt_editReq( w_payloadPtr, w_requestId );
			break;

		case D_MSG_MSI_O_RAN_PFM_MNG_GET_REQ :		/* o-ran-Perfomance Management GET要求	*/
			ret = f_pfm_o_ran_pfm_mgmt_getReq( w_payloadPtr, w_requestId );
			break;
