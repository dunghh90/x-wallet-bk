...
*
*/
INT f_dhcp_msi_recv_ind( VOID *msgP )
{
	UINT						w_messageId;
	UINT						w_requestId;
	...
	switch( w_messageId )
	{
		case D_MSG_MSI_O_RAN_DHCP_GET_REQ :						/* o-ran-dhcp GET要求		*/
			ret = f_dhcp_o_ran_dhcp_getReq( w_payloadPtr, w_requestId );
			break;

		case D_MSG_MSI_O_RAN_MPLANE_INT_EDIT_REQ :				/* o-ran-mplane-int EDIT要求			*/
			ret = f_dhcp_o_ran_mplane_int_editReq( w_payloadPtr, w_requestId );
			break;

		case D_MSG_MSI_O_RAN_MPLANE_INT_GET_REQ :				/* o-ran-mplane-int GET要求			*/
			ret = f_dhcp_o_ran_mplane_int_getReq( w_payloadPtr, w_requestId );
			break;
