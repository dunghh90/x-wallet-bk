 ...
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_m_res_reeqpinf_end(                           /* なし:R */
    ...
    /*
     * 配下REからの報告内容は、L3_RCTにおいてチェックするためここでは見ない
     * if (ret_code == CMD_NML) {
    ...
    /* RE状態(セクタ部)管理テーブル(RE装置構成情報)設定  */
    /*****************************************************/
    f_trp_rec_Fc02_t_reeqpinf_set(                                /* 変化:R */
    ...
    /* スレッド間(REスロット情報報告要求プロシージャ実行指示)送信   */
    /****************************************************************/
    f_trp_rec_Fc02_t_it_resltinfprc_snd(                          /* なし:R */
    );
