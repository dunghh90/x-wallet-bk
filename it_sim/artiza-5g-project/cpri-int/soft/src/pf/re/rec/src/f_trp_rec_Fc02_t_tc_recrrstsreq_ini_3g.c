...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_t_tc_recrrstsreq_ini_3g.c
 ...
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_t_tc_recrrstsreq_ini_3g(                         /* なし:R */
) {
    ...
    {
        f_trp_rec_Wc02_stsmng_tbl_3g.sts[cpr_no_idx].tc.recrrstsreq 
