...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_m_res_recrdssc_sta_3g.c
 ...
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_m_res_recrdssc_sta_3g(                           /* なし:R */
...
// [16B] add start
    ...
    /* REカード状態(セクタ部)未取得スロット番号取得 */
    /************************************************/
    slt_no = f_trp_rec_Fc02_t_ugrecrdssc_get_3g(       /* 未取得スロット番号:R */
    );

// [16B] add start
//	/* Slot番号からSlotのIndex値(0-15)を算出する 16B KCN add */
//	f_cmn_com_slotsrch_3g(D_REC_C02_3G_CPR_NO(), slt_no, &slt_no_idx);
// [16B] add end
    ...
    if (slt_no == CMD_NUM0) {
        ...
        // カード状態をポート集約する
        f_trp_rec_Fc02_t_recrdssc_i_merge_3g();
...
// [16B] add end
    ...
    /******************************************/
    tc = f_trp_rec_Fc02_t_tc_recrdstsreq_get_3g(           /* 残トライ回数:R */
        slt_no                                          /* スロット番号:I */
    );
...
// [16B] add start
        ...
        /* トライ不可能な場合 */
        if (tc <= CMD_NUM0) {
            snprintf(errdata, CMD_NUM48, "[NOTICE][cpr:%02d][slt:0x%02x]RE Card Status NG.", D_REC_C02_3G_CPR_NO(), slt_no);
            D_REC_IVLINI();
            ...
            /**************************************************/
            f_trp_rec_Fc02_t_ngrecrdssc_set_3g(                     /* なし:R */
                slt_no
...
// [16B] add end
            ...
            snprintf(errdata, CMD_NUM48, "[FRCRST][cpr:%02d][slt:0x%02x]RE Card Status NG.", D_REC_C02_3G_CPR_NO(), slt_no);
            D_REC_IVLINI();
            D_REC_IVLSET_SIZE(bufp, sizeof(CMT_TSKIF_RECRDSSCPRCIND));
...
//        slt_no_idx                                            /* スロット番号:I */
    ...
    /**************************************************/
    f_trp_rec_Fc02_t_tc_recrdstsreq_dec_3g(                          /* なし:R */
        slt_no                                            /* スロット番号:I */
    );
