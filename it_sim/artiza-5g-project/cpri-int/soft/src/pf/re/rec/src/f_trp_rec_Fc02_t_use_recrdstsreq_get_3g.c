 ...
 * @return 残トライ回数
 * @date   2010/08/11 CMS)Takahashi create.
 * @date   2015/08/07 fpt_tan Modify.
 */
/****************************************************************************/
USHORT f_trp_rec_Fc02_t_use_recrdstsreq_get_3g(              /* 残トライ回数:R */
    ...
    /* 残トライ回数リターン */
    /************************/
    return f_trp_rec_Wc02_stsmng_tbl_3g.sts[cpr_no_idx].tc.m_recrdstsreq[slt_no_idx];
}
