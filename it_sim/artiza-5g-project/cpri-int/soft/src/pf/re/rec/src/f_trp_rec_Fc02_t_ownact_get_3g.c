 ...
 */
/****************************************************************************/
USHORT f_trp_rec_Fc02_t_ownact_get_3g(                         /* Active状態:R */
) {
    ...
    if (D_REC_C02_3G_CPR_NO() == f_trp_rec_Wcom_remcm_tbl_3g.actsts[actlnk_gr - CMD_NUM1].cpr_no) {
        /* Active状態を設定 */
        actsts = f_trp_rec_Wcom_remcm_tbl_3g.actsts[actlnk_gr - CMD_NUM1].sts;
    }
    /* CPRI番号が一致しない場合 */
    else {
        /* Negativeを設定 */
