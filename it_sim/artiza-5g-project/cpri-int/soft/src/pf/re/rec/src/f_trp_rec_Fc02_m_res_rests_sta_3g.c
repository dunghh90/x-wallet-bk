 ...
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_m_res_rests_sta_3g(                              /* なし:R */
...
//     /* 残トライ回数(RE状態報告要求)取得         */
//     /********************************************/
//     tc = f_trp_rec_Fc02_t_tc_restsreq_get_3g(                /* 残トライ回数:R */
//     );
...
//         /* トライ不可能な場合 */
//         if (tc <= CMD_NUM0) {
//             snprintf(errdata, CMD_NUM48, "[NOTICE][cpr:%02d]RE Status NG.", D_REC_C02_3G_CPR_NO());
//             D_REC_IVLINI();
...
//         }
//         else {
//             snprintf(errdata, CMD_NUM48, "[FRCRST][cpr:%02d]RE Status NG.", D_REC_C02_3G_CPR_NO());
//             D_REC_IVLINI();
//             D_REC_IVLSET_SIZE(bufp, sizeof(CMT_TSKIF_RESTSPRCIND));
...
//     /****************************************************/
//     f_trp_rec_Fc02_t_tc_restsreq_dec_3g(                             /* なし:R */
//     );
