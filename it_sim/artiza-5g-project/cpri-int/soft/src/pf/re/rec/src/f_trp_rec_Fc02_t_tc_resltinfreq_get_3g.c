...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_t_tc_resltinfreq_get_3g.c
 ...
 */
/****************************************************************************/
USHORT f_trp_rec_Fc02_t_tc_resltinfreq_get_3g(               /* 残トライ回数:R */
) {
    ...
    /* 残トライ回数リターン */
    /************************/
    return f_trp_rec_Wc02_stsmng_tbl_3g.sts[cpr_no_idx].tc.resltinfreq;
}
