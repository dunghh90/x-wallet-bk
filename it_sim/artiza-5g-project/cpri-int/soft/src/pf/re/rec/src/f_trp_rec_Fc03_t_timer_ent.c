...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc03_t_timer_ent.c
 * @brief  タイマ登録
 ...
 */
/****************************************************************************/
UINT f_trp_rec_Fc03_t_timer_ent(                            /* 終了コード:R */
    ...
    /* 要素設定 */
    elm.cls    = EC_REC_C03;                                      /* クラス */
    elm.tmk    = tmk;                                         /* タイマ種別 */
    elm.cpr_no = D_REC_C03_CPR_NO();                            /* CPRI番号 */
    elm.soc_no = D_REC_C03_CRR_NO();                        /* キャリア番号 */
