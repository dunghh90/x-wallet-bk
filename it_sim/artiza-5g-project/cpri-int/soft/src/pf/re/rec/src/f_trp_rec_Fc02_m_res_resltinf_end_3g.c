...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_m_res_resltinf_end_3g.c
 ...
 * @return None
 * @date   2008/07/21 FFCS)Shihzh create.
 * @date   2015/09/24 FPT)Tan update for FHM.
 * @date   2015/10/29 TDI)satou FHM技説-QA-113 強制停止の要因を通知するように
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_m_res_resltinf_end_3g(                           /* なし:R */
    ...
    /* RE状態(セクタ部/共通部)管理テーブル(REスロット情報)設定  */
    /************************************************************/
    f_trp_rec_Fc02_t_resltinf_set_3g(                                /* 変化:R */
