...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_t_tc_refrcrstsnd_ini_3g.c
 ...
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_t_tc_refrcrstsnd_ini_3g(                         /* なし:R */
) {
    ...
    {
        f_trp_rec_Wc02_stsmng_tbl_3g.sts[cpr_no_idx].tc.refrcrstsnd
	...
	printf( "**FHM**[%d]%s cpr_no:%d, tc.refrcrstsnd:%d \n",__LINE__,__FUNCTION__,
		cpr_no_idx + 1, f_trp_rec_Wc02_stsmng_tbl_3g.sts[cpr_no_idx].tc.refrcrstsnd);
#endif
    return;
}
