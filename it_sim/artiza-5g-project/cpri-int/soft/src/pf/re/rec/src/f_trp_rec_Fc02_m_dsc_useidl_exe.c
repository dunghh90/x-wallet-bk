...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_m_dsc_useidl_exe.c
 ...
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_m_dsc_useidl_exe(                             /* なし:R */
    VOID* bufp                                        /* バッファポインタ:I */
) {
    T_RRH_LAYER3 shmLayer3;
	USHORT cpr_idx = D_REC_C02_CPR_NO() - CMD_NUM1;
...
//
    ...
    {   /* 起動中→強制リセット */
        ...
        /* 強制リセット実行プロシージャ */
        /********************************/
        f_trp_rec_Fc02_t_it_refrcrstprc_snd();
