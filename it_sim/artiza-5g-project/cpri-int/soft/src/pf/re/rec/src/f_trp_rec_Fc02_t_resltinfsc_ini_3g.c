...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_t_resltinfsc_ini_3g.c
 ...
 */
/****************************************************************************/
UINT f_trp_rec_Fc02_t_resltinfsc_ini_3g(                          /* 変化:R */
    USHORT ink                                              /* 初期化種別:I */
) {
...
// [16B] add end
    ...
    /* テーブルREスロット情報アドレス抽出 */
    tblp = &(f_trp_rec_Wcom_remsc_tbl_3g.remsc[cpr_no_idx].resltinf);
    /* テーブル(BK)REスロット情報アドレス抽出 */
    tbkp = &(f_trp_rec_Wcom_remsc_tbk_3g.remsc[cpr_no_idx].resltinf);
    /* テーブル→テーブル(BK)にコピー */
