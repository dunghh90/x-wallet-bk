 ...
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_m_res_recrrsts_sta_3g(                           /* なし:R */
    ...
    /********************************************/
    tc = f_trp_rec_Fc02_t_tc_recrrstsreq_get_3g(             /* 残トライ回数:R */
    );
    ...
    if (tc <= CMD_NUM0) {
        ...
        /* トライ不可能な場合 */
        if (tc <= CMD_NUM0) {
            snprintf(errdata, CMD_NUM48, "[NOTICE][cpr:%02d]RE Carrier Status NG.", D_REC_C02_3G_CPR_NO());
            D_REC_IVLINI();
            ...
            snprintf(errdata, CMD_NUM48, "[FRCRST][cpr:%02d]RE Carrier Status NG.", D_REC_C02_3G_CPR_NO());
            D_REC_IVLINI();
            D_REC_IVLSET_SIZE(bufp, sizeof(CMT_TSKIF_RECRRSTSPRCIND));
    ...
    /****************************************************/
    f_trp_rec_Fc02_t_tc_recrrstsreq_dec_3g(                          /* なし:R */
    );
