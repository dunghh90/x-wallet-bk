...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_t_tc_refrcrst_ini.c
 ...
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_t_tc_refrcrst_ini(                            /* なし:R */
) {
    ...
    {
        f_trp_rec_Wc02_stsmng_tbl.sts[cpr_no_idx].tc.refrcrst
	...
	printf( "**FHM**[%d]%s cpr_no:%d, tc.refrcrst:%d \n",__LINE__,__FUNCTION__,
		cpr_no_idx + 1, f_trp_rec_Wc02_stsmng_tbl.sts[cpr_no_idx].tc.refrcrst);
#endif
    return;
}
