...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_m_rst_refrcrst_sta_3g.c
 * @brief  RE強制リセット開始処理
 ...
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_m_rst_refrcrst_sta_3g(                           /* なし:R */
    ...
    /* 残トライ回数(RE強制リセット)取得 */
    /************************************/
    tc = f_trp_rec_Fc02_t_tc_refrcrst_get_3g(                /* 残トライ回数:R */
    );

    /* トライ不可能な場合 */
    if (tc <= CMD_NUM0) {
        /* 無効処理履歴 */
        snprintf(errdata, CMD_NUM48, "[FRCSTP][cpr:%02d]Force reset NG.", D_REC_C02_3G_CPR_NO());
        D_REC_IVLINI();
