 ...
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_m_use_rests_end(                              /* なし:R */
    ...
    if (ret_code != CMD_NML) {
        ...
        /************************************************/
        uit_ret = f_trp_rec_Fc02_t_rests_ini(                     /* 変化:R */
            D_REC_INK_RNG                                   /* 初期化種別:I */
        );
        if (uit_ret == CMD_ON) {
            snprintf(errdata, CMD_NUM48, "[NOTICE][cpr:%02d][ret:0x%04x]RE sts report NG.", D_REC_C02_CPR_NO(), ret_code);
            D_REC_IVLINI();
    ...
    /**********************************************/
    uit_ret = f_trp_rec_Fc02_t_rests_set(                     /* 変化:R */
