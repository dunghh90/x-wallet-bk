 ...
 */
/****************************************************************************/
UINT f_trp_rec_Fc02_t_recrrsts_a_ini(                             /* 変化:R */
    USHORT ink                                              /* 初期化種別:I */
) {
	T_RRH_CARST_S3G  ltCarStaLte = {};


//	/* get share memmory */
//	f_cmn_com_carst_s3g_get(D_REC_C02_CPR_NO(), &ltCarStaLte);

	ltCarStaLte.signal_kind = 0;
	
	/* set share memmory */
	f_cmn_com_carst_s3g_set( D_REC_C02_CPR_NO(), &ltCarStaLte);
