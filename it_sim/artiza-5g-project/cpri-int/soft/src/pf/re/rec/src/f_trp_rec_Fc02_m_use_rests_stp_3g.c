...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_m_use_rests_stp_3g.c
 * @brief  運用中RE状態報告中止処理
 ...
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_m_use_rests_stp_3g(                              /* なし:R */
	...
	SHORT tc;
    T_RRH_REST_3G         ltReStaArr3G;
    /* 関数トレースログ */
    F_COMF_CMM_FFUNCTRCLOG(D_TCM_TRCLOGLV_OTH, NULL, NULL);
    
    /*	INVALIDログ	*/
    snprintf(errdata, CMD_NUM48, "[cpr:%02d][TRY=%d][3G]RE sts report T.O.",
    		 cpr_no, f_trp_rec_Wc02_stsmng_tbl_3g.sts[cpr_no_idx].tc.m_restsreq);
    D_REC_IVLINI();
	...
	tc = f_trp_rec_Wc02_stsmng_tbl_3g.sts[cpr_no_idx].tc.m_restsreq;
    ...
    /********************************************/
    f_trp_rec_Fc02_t_rests_ini_3g(D_REC_INK_RTO);
    ...
    f_trp_com_Fmemclr(                                   /* 終了コード:R     */
        &ltReStaArr3G,                                  /* RE状態アドレス:I */
        sizeof(T_RRH_REST_3G)                           /* RE状態サイズ:I   */
    );
	
	f_cmn_com_rest_3g_set( cpr_no, &ltReStaArr3G );
