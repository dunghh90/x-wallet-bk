...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_t_tofval_ini_3g.c
 ...
 */
/****************************************************************************/
UINT f_trp_rec_Fc02_t_tofval_ini_3g(                                 /* 変化:R */
    USHORT ink                                              /* 初期化種別:I */
) {
    ...
    /* テーブルToffset値アドレス抽出 */
    tblp = &(f_trp_rec_Wcom_remsc_tbl_3g.remsc[cpr_no_idx].tofval);
    /* テーブル(BK)Toffset値アドレス抽出 */
    tbkp = &(f_trp_rec_Wcom_remsc_tbk_3g.remsc[cpr_no_idx].tofval);
    /* テーブル→テーブル(BK)にコピー */
