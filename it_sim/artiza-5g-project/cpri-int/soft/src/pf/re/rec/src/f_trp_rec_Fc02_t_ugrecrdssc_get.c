...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_t_ugrecrdssc_get.c
 ...
 */
/****************************************************************************/
USHORT f_trp_rec_Fc02_t_ugrecrdssc_get(                   /* スロット番号:R */
) {
...
//    /**********************************************************************/
//    f_trp_rec_Fc02_t_resltlsc_get(                                /* なし:R */
//        &slt_lst                                    /* スロット番号リスト:O */
//    );

    slt_num = f_trp_rec_Wcom_remsc_tbl.remsc[cpr_no_idx].resltinf.slt_num;

    crdssc_get = f_trp_rec_Wc02_stsmng_tbl.sts[cpr_no_idx].crdssc_num;
...
//    return (slt_lst.slt_no[slt_lst_idx]);
    return (f_trp_rec_Wcom_remsc_tbl.remsc[cpr_no_idx].resltinf.slt_no[slt_lst_idx]);
}
// [16B] add end
