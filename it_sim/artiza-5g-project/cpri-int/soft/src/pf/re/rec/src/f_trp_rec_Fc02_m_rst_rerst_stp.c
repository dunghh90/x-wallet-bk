...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_m_rst_rerst_stp.c
 * @brief  REリセット中止処理
 ...
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_m_rst_rerst_stp(                              /* なし:R */
    ...
    snprintf(errdata, CMD_NUM48, "[NOTICE][cpr:%02d]RE Reset confirm T.O.", D_REC_C02_CPR_NO());
    D_REC_IVLINI();
