 ...
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_m_res_reeqpinf_sta(                           /* なし:R */
    ...
    /********************************************/
    tc = f_trp_rec_Fc02_t_tc_reeqpinfreq_get(             /* 残トライ回数:R */
    );
    
    /* トライ不可能な場合 */
    if (tc <= CMD_NUM0) {
        snprintf(errdata, CMD_NUM48, "[FRCRST][cpr:%02d]RE Reqpinf report NG.", D_REC_C02_CPR_NO());
        D_REC_IVLINI();
    ...
    /* L3(RE装置構成情報報告要求)送信 */
    /**********************************/
    f_trp_rec_Fc02_t_l3_reeqpinfreq_snd(                          /* なし:R */
    );

    /****************************************************/
    /* 残トライ回数(RE装置構成情報報告要求)デクリメント */
    /****************************************************/
    f_trp_rec_Fc02_t_tc_reeqpinfreq_dec(                          /* なし:R */
    );
