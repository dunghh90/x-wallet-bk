...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_m_res_sta.c
 * @brief  RE起動開始処理
 ...
 * @return None
 * @date   2007/03/20 FJT)Nagasima create.
 * @date   2016/10/26 KCN)hfuku 16Bデバッグ機能追加.
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_m_res_sta(                                    /* なし:R */
...
#ifdef OPT_16B_IT
	{/* dbg_printf出力の初期状態を設定する(1:有効/0:無効) */
		UCHAR pInData = 1; /* 1=有効化 */
//		UCHAR pInData = 0; /* 0=無効化 */
		f_cmn_com_print_offon_set(&pInData);
	}
#endif
    ...
    /*****************************************************/
    f_trp_rec_Fc02_t_resltinfsc_ini(
        D_REC_INK_SHC
    );
    ...
    /***************************************************************/
    f_trp_rec_Fc02_t_recrrsts_a_ini(                              /* 変化:R */
        D_REC_INK_SHC                                         /* 初期化種別 */
    );

	/*	L3送受信ログクリア	*/
	f_trp_rec_Fcom_t_l3_LogClr( D_REC_C02_CPR_NO() );

    /**************************************************/
    /* スレッド間(RE時刻設定プロシージャ実行指示)送信 */
    /**************************************************/
    f_trp_rec_Fc02_t_it_retimsetprc_snd(                          /* なし:R */
    );
