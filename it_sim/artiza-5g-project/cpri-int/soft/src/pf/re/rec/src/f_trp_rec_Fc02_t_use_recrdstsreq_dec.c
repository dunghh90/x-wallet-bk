...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_t_use_recrdstsreq_dec.c
 ...
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_t_use_recrdstsreq_dec(                        /* なし:R */
    ...
    /* 残トライ回数デクリメント */
    /****************************/
    f_trp_rec_Wc02_stsmng_tbl.sts[cpr_no_idx].tc.m_recrdstsreq[slt_no_idx]--;
