 ...
 */
/****************************************************************************/
UINT f_trp_rec_Fc02_t_reeqpinf_set(                               /* 変化:R */
    VOID* l3_bufp                                   /* L3バッファポインタ:I */
) {
    USHORT cpr_no_idx = D_REC_C02_CPR_NO() - CMD_NUM1;
                                                    /* CPRI番号インデックス */
    CPRIEQPSTR_INF_S3G   *rcvp;               /* 受信RE装置構成情報アドレス */
...
//    CHAR                 errdata[CMD_NUM48];
    ...
    /* 設定RE装置構成情報アドレス抽出 */
    rcvp = &(((CMT_CPRIF_EQPSTRRES_S3G*)l3_bufp)->cpristr_inf);
    /* テーブルRE装置構成情報アドレス抽出 */
    tblp = &(f_trp_rec_Wcom_remsc_tbl.remsc[cpr_no_idx].reeqpinf);
    /* テーブルRE装置構成情報アドレス抽出 */
    tbkp = &(f_trp_rec_Wcom_remsc_tbk.remsc[cpr_no_idx].reeqpinf);
	...
	f_cmn_com_eqp_s3g_set(                                   /* 終了コード:R */
        D_REC_C02_CPR_NO(),                        /* CPRI番号インデックス:I */
        (T_RRH_EQP_S3G *)l3_bufp             /* 設定RE装置構成情報アドレス:I */
    );
    /************/
    /* 新旧比較 */
    /************/
