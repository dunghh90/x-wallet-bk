...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_m_rst_rerst_sta_3g.c
 * @brief  REリセット開始処理
 ...
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_m_rst_rerst_sta_3g(                              /* なし:R */
    VOID* bufp                                        /* バッファポインタ:I */
) {
/* 2021/02/01 M&C) No27 - File update (start delete) */
//     SHORT tc;                                               /* 残トライ回数 */
...
//     /* 残トライ回数(REリセット要求)取得 */
//     /************************************/
//     tc = f_trp_rec_Fc02_t_tc_rerstreq_get_3g(                /* 残トライ回数:R */
//     );

//     /* トライ不可能な場合 */
//     if (tc <= CMD_NUM0) {
//         /* 無効処理履歴 */
//         snprintf(errdata, CMD_NUM48, "[FRCRST][cpr:%02d]RE reset NG.", D_REC_C02_3G_CPR_NO());
//         D_REC_IVLINI();
...
//     /* L3(REリセット要求)送信 */
//     /**************************/
//     f_trp_rec_Fc02_t_l3_rerstreq_snd_3g(                             /* なし:R */
//     );

//     /********************************************/
//     /* 残トライ回数(REリセット要求)デクリメント */
//     /********************************************/
//     f_trp_rec_Fc02_t_tc_rerstreq_dec_3g(                             /* なし:R */
//     );
...
//     );
/* 2021/02/01 M&C) No27 - File update (end delete) */
    return;
}
