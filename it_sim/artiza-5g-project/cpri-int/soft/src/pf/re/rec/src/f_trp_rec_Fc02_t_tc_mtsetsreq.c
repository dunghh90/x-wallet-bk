...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_t_tc_mtsetsreq.c
...
VOID f_trp_rec_Fc02_t_tc_mtsetsreq_set( USHORT awRetryCnt)
{
    ...
    /* 残トライ回数 設定*/
    /************************/
    f_trp_rec_Wc02_stsmng_tbl.sts[cpr_no_idx].tc.mtaddsetscnt =  awRetryCnt;
#ifdef FHM_DEBUG_FOR_IT1
	printf( "**FHM**[%d]%s cpr_no=%d, tc.mtaddsetscnt=%d \n",__LINE__,__FUNCTION__,
		cpr_no_idx + 1, f_trp_rec_Wc02_stsmng_tbl.sts[cpr_no_idx].tc.mtaddsetscnt);
#endif
}
...
USHORT f_trp_rec_Fc02_t_tc_mtsetsreq_get() 
{
    ...
    /* 残トライ回数リターン */
    /************************/
    return f_trp_rec_Wc02_stsmng_tbl.sts[cpr_no_idx].tc.mtaddsetscnt;
}
