...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_m_res_refrcrst_sta.c
 * @brief  RE強制リセット開始処理
 ...
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_m_res_refrcrst_sta(                           /* なし:R */
    ...
    if (tc <= CMD_NUM0) {
        /* 無効処理履歴 */
        snprintf(errdata, CMD_NUM48, "[FRCSTP][cpr:%02d]RE Force Reset Sending Over.", D_REC_C02_CPR_NO());
        D_REC_IVLINI();
    ...
    /************************************************/
    f_trp_rec_Fc02_t_tc_refrcrstsnd_dec(                          /* なし:R */
    );
