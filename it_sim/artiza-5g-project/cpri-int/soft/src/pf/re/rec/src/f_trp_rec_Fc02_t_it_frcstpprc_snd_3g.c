...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_t_it_frcstpprc_snd_3g.c
 ...
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_t_it_frcstpprc_snd_3g(T_RRH_RESTOP_FACTOR stopFactor
) {
    ...
    UINT   msglen = sizeof(CMT_TSKIF_FRCSTPPRCIND) - sizeof(T_MSGHEAD);
                                                            /* メッセージ長 */
    UINT   msgid  = CMD_TSKIF_FRCSTPPRCIND_3G;              /* メッセージID */
	...
	{
    	bufp->cpri_no = D_REC_C03_3G_CPR_NO();                  /* CPRI番号 */
	}
	else
	{
