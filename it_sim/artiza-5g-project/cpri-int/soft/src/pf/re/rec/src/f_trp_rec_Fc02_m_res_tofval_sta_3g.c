 ...
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_m_res_tofval_sta_3g(                          /* なし:R */
    ...
    /***************************************/
    tc = f_trp_rec_Fc02_t_tc_tofvalreq_get_3g(               /* 残トライ回数:R */
    );

    /* トライ不可能な場合 */
    if (tc <= CMD_NUM0) {
        snprintf(errdata, CMD_NUM48, "[FRCRST][cpr:%02d]Tofset report NG.", D_REC_C02_3G_CPR_NO());
        D_REC_IVLINI();
    ...
    /* L3(Toffset値報告要求)送信 */
    /*****************************/
    f_trp_rec_Fc02_t_l3_tofvalreq_snd_3g(                         /* なし:R */
    );

    /***********************************************/
    /* 残トライ回数(Toffset値報告要求)デクリメント */
    /***********************************************/
    f_trp_rec_Fc02_t_tc_tofvalreq_dec_3g(                          /* なし:R */
    );
