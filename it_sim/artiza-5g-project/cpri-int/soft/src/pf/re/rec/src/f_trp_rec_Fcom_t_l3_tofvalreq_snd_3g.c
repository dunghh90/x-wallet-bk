...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fcom_t_l3_tofvalreq_snd_3g.c
 ...
 */
/****************************************************************************/
UINT f_trp_rec_Fcom_t_l3_tofvalreq_snd_3g(                     /* 終了コード:R */
    ...
    /* バッファ設定(CPRIデータ) */
    /****************************/
    bufp->cpridat_toffsetinfreq.signal_kind = CMD_CPRID_TOFFSETINFREQ;
                                                                /* 信号種別 */
