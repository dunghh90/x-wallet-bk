...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc03_r_evt_cnv_3g.c
 * @brief  イベント変換
 ...
 * @date   2015/10/16 TDI)satou 問処番号No.98 CPRI信号受信通知のメッセージID修正
 ...
 */
/****************************************************************************/
ET_REC_C03_EVT f_trp_rec_Fc03_r_evt_cnv_3g(                      /* イベント:R */
   ...
   USHORT* crr_nop                                        /* キャリア番号:O */
    ...
    case D_API_MSGID_L2_CPRIMSG_RCV_NTC:
        ...
        case CMD_CPRID_CARLSTSRES:
            ...
            /* 00)REからキャリア状態報告応答受信          */
            /*============================================*/
            evt    = EC_REC_C03_EVT_IT_RECRRSTS_RSP;
            cpr_no = ((CMT_TSKIF_CPRIRCV_SIGNALGET*)datp)->
                     cprircv_inf.link_num;
            crr_no = D_REC_CARNO_ALL;
            break;
