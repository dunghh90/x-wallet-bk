...
/*!
 * @skip   $ld:$
 * @file   f_trp_rec_Fc02_t_tc_recrdstsreq_ini.c
 ...
 */
/****************************************************************************/
VOID f_trp_rec_Fc02_t_tc_recrdstsreq_ini(                         /* なし:R */
    ...
    {
        f_trp_rec_Wc02_stsmng_tbl.sts[cpr_no_idx].tc.recrdstsreq[slt_no_idx]
