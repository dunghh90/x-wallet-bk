/*!
 * @skip   $Id$
 * @file   m_dl_fl_syspinf_cnf_to.c
 * @brief  Event:システムパラメータ情報報告確認タイマタイムアウト通知, 対REC状態:FHM自律DL処理中.
...
VOID m_dl_fl_syspinf_cnf_to(VOID* bufp, USHORT cpri_no)
{
	USHORT		lwReNo;
	USHORT		lwSysType;

	cm_Assert( CMD_ASL_NOLEVEL, CMD_NUM0,"[m_dl_fl_syspinf_cnf_to] ENTER" );
	...
	cm_Assert( CMD_ASL_NOLEVEL, CMD_NUM0,"[m_dl_fl_syspinf_cnf_to] RETURN" );
