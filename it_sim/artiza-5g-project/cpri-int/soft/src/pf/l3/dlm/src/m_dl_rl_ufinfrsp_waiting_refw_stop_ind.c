/*!
 * @skip   $Id$
 * @file   m_dl_rl_ufinfrsp_waiting_refw_stop_ind.c
...
VOID m_dl_rl_ufinfrsp_waiting_refw_stop_ind(VOID* bufp, USHORT cpri_no)
{
	cm_Assert( CMD_ASL_NOLEVEL, CMD_NUM0,	"[m_dl_rl_ufinfrsp_waiting_refw_stop_ind] ENTER" );
	...
	cm_Assert( CMD_ASL_NOLEVEL, CMD_NUM0,	"[m_dl_rl_ufinfrsp_waiting_refw_stop_ind] RETURN" );
