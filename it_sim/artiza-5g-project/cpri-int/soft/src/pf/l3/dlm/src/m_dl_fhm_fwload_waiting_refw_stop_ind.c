/*!
 * @skip   $Id$
 * @file   m_dl_fhm_fwload_waiting_refw_stop_ind.c
 * @brief  Event: REファイル更新中止指示(L3/DLM←L3/RCT) RE status 2 DLD_RESTA_RE_FILEREAD
...
VOID m_dl_fhm_fwload_waiting_refw_stop_ind(VOID* bufp, USHORT cpri_no)
{
	E_RRHAPI_RCODE	leRtn;

	cm_Assert(CMD_ASL_NOLEVEL, cpri_no, "[m_dl_fhm_fwload_waiting_refw_stop_ind] ENTER");
	...
	{
		cm_Assert(CMD_ASL_NOLEVEL, leRtn, "rrhApi_File_Mnt_CancelUpdFirm NG");
	}
