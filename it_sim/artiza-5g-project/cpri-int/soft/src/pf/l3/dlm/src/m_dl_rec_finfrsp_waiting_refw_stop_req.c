/*!
 * @skip   $Id$
 * @file   m_dl_rec_finfrsp_waiting_refw_stop_req.c
...
VOID m_dl_rec_finfrsp_waiting_refw_stop_req(VOID* bufp, USHORT cpri_no)
{
	USHORT						lwTimerId;
	INT							ldwerrcd;
	UINT						ldwResult;
	
	cm_Assert( CMD_ASL_NOLEVEL, CMD_NUM0,	"[m_dl_rec_finfrsp_waiting_refw_stop_req] ENTER" );
	...
	cm_Assert( CMD_ASL_NOLEVEL, CMD_NUM0,	"[m_dl_rec_finfrsp_waiting_refw_stop_req] RETURN" );
	return ;
}
