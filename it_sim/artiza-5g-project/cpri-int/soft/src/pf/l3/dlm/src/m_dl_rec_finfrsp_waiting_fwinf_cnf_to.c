/*!
 * @skip   $Id$
 * @file   m_dl_rec_finfrsp_waiting_fwinf_cnf_to.c
 * @brief  the processing for ファームウェアファイル情報報告確認T.O.
 ...
 *  @date   2015/08/20 FPT)VietCV Create
 *  @date   2015/10/14 FPT)DuongCD update comment No.269, No.270, No.274
 *  @date   2015/10/20 TDIPS)sasaki M-RRU-ZSYS-01816 Update IT2問処No.118対処
 */
 
VOID m_dl_rec_finfrsp_waiting_fwinf_cnf_to(VOID* bufp, USHORT cpri_no)
{
	INT							ldwerrcd;
	USHORT						lwTimerId;
	UINT						ldwResult;
	...
	cm_Assert( CMD_ASL_NOLEVEL, CMD_NUM0,	"[m_dl_rec_finfrsp_waiting_fwinf_cnf_to] ENTER" );
	...
	cm_Assert( CMD_ASL_NOLEVEL, CMD_NUM0,	"[m_dl_rec_finfrsp_waiting_fwinf_cnf_to] RETURN" );
