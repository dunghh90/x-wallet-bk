/*!
 * @skip   $Id$
 * @file   m_dl_rl_fsndcmprsp_waiting_finf_ntc_ng.c
 ...
 *  @return Void.
 *  @retval -
 *  @date   2015/08/26 FPT)DuongCD Create
 *  @date   2015/09/21 FPT)Yen update comment
 */

VOID m_dl_rl_fsndcmprsp_waiting_finf_ntc_ng(VOID* bufp, USHORT cpri_no)
{
	USHORT			lwSysType;

	cm_Assert( CMD_ASL_NOLEVEL, CMD_NUM0,	"[m_dl_rl_fsndcmprsp_waiting_finf_ntc_ng] ENTER" );
	...
	cm_Assert( CMD_ASL_NOLEVEL, CMD_NUM0,	"[m_dl_rl_fsndcmprsp_waiting_finf_ntc_ng] RETURN" );
