/*!
 * @skip   $Id$
 * @file   m_dl_rec_fsnd_waiting_fw_stop_req.c
...
VOID m_dl_rec_fsnd_waiting_fw_stop_req(VOID* bufp, USHORT cpri_no)
{
	
	cm_Assert( CMD_ASL_NOLEVEL, CMD_NUM0,	"[m_dl_rec_fsnd_waiting_fw_stop_req] ENTER" );
	...
	cm_Assert( CMD_ASL_NOLEVEL, CMD_NUM0,	"[m_dl_rec_fsnd_waiting_fw_stop_req] RETURN" );
	return ;
}
