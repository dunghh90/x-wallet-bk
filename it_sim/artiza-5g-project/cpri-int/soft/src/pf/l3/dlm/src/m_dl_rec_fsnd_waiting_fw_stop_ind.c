/*!
 * @skip   $Id$
 * @file   m_dl_rec_fsnd_waiting_fw_stop_ind.c
...
/*!
 *  @brief  the processing for "REファイル更新中止指示" receiving at the ファイルデータ送信中(FW) RE state.
 *  @note   
...
VOID m_dl_rec_fsnd_waiting_fw_stop_ind(VOID* bufp, USHORT cpri_no)
{
	
	cm_Assert( CMD_ASL_NOLEVEL, CMD_NUM0,	"[m_dl_rec_fsnd_waiting_fw_stop_ind] ENTER" );
	...
	cm_Assert( CMD_ASL_NOLEVEL, CMD_NUM0,	"[m_dl_rec_fsnd_waiting_fw_stop_ind] RETURN" );
	return ;
}
