/*!
 * @skip   $Id$
 * @file   m_dl_fl_syspsndcmp_cnf_to.c
 * @brief  Event:システムパラメータ送信完了確認タイマタイムアウト通知, 対REC状態:FHM自律DL処理中.
...
VOID m_dl_fl_syspsndcmp_cnf_to(VOID* bufp, USHORT cpri_no)
{
	USHORT		lwSysType;
	USHORT		lwReNo;

	cm_Assert( CMD_ASL_NOLEVEL, CMD_NUM0,"[m_dl_fl_syspsndcmp_cnf_to] ENTER" );
	...
	cm_Assert( CMD_ASL_NOLEVEL, CMD_NUM0,"[m_dl_fl_syspsndcmp_cnf_to] RETURN" );
