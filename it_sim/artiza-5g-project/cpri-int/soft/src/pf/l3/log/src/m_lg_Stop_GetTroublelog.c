/*!
 * @skip   $Id$
 * @file   m_lg_Stop_GetTroublelog.c
...
VOID m_lg_Stop_GetTroublelog( UCHAR *a_rcv_adr, USHORT a_rec_typ )
{
	cm_Assert(D_RRH_LOG_AST_LV_ENTER, 0, "m_lg_Stop_GetTroublelog enter");
	...
	cm_Assert(D_RRH_LOG_AST_LV_RETURN, 0, "m_lg_Stop_GetTroublelog return");
}
