 ...
 *  @skip    $Id:$
 *  @file    rrhlib_api.c
 *  @brief	rrh command API library routine
...
/* INV api(mpn) */
	{ 
	  "duApi_Mpn_Mnr_MplaneReady"    , (E_RRHAPI_RCODE(*)(INT qid, ...))duApi_Mpn_Mnr_MplaneReady    ,
	   8 , { MRB_TT_FIXNUM, MRB_TT_FIXNUM, MRB_TT_FIXNUM, MRB_TT_FIXNUM, MRB_TT_FIXNUM, MRB_TT_FIXNUM, MRB_TT_FIXNUM, MRB_TT_FIXNUM }
	},
#if 0
	{ 
	  "duApi_Mpn_Mnr_MplaneStart"    , (E_RRHAPI_RCODE(*)(INT qid, ...))duApi_Mpn_Mnr_MplaneStart    ,
...
/* INV api(ptp) */
	...
	{ 
	  "duApi_Ptp_Mqr_CtlPtpDevice"       , (E_RRHAPI_RCODE(*)(INT qid, ...))duApi_Ptp_Mqr_CtlPtpDevice       ,
	   6 , { MRB_TT_FIXNUM, MRB_TT_FIXNUM, MRB_TT_FIXNUM ,MRB_TT_FIXNUM, MRB_TT_FIXNUM, MRB_TT_FIXNUM  }
	},
/* INV api(eqs) */
	{ 
	  "rrhApi_Svp_Mnt_Dbg_svCtl"       , (E_RRHAPI_RCODE(*)(INT qid, ...))rrhApi_Svp_Mnt_Dbg_svCtl       ,
	   6 , { MRB_TT_FIXNUM, MRB_TT_FIXNUM, MRB_TT_FIXNUM, MRB_TT_FIXNUM, MRB_TT_FIXNUM, MRB_TT_FIXNUM }
	},
	{ 
	  "rrhApi_Svp_Mnt_Inhibit_stpWv_tp", (E_RRHAPI_RCODE(*)(INT qid, ...))rrhApi_Svp_Mnt_Inhibit_stpWv_tp,
	   3 , { MRB_TT_FIXNUM, MRB_TT_FIXNUM, MRB_TT_FIXNUM }
	},
/* INV api(eio) */
	{ 
	  "rrhApi_Ext_Mnt_FanDbgModeChgNtc", (E_RRHAPI_RCODE(*)(INT qid, ...))rrhApi_Ext_Mnt_FanDbgModeChgNtc,
	   3 , { MRB_TT_FIXNUM, MRB_TT_FIXNUM, MRB_TT_FIXNUM }
	},
/* funciton */
	{ NULL                          , NULL                        , 0 ,{0} }
