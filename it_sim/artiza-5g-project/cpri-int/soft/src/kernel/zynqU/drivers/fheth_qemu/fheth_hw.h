...
#define E25G_SPLANE_RX_SEC1             (0x00030000) /* S-plane受信タイムスタンプ(秒上位) */
#define E25G_SPLANE_RX_SEC2             (0x00030004) /* S-plane受信タイムスタンプ(秒下位) */
#define E25G_SPLANE_RX_NSEC             (0x00030008) /* S-plane受信タイムスタンプ(n秒) */
#define E25G_SPLANE_RX_FLAG             (0x0003000C) /* S-plane受信フラグオフセット */
...
#define E25G_MPLANE_RX_FLAG             (0x0003000C) /* M-plane受信フラグオフセット */
...
#define BANKNOM_LENGTH                  (0x03FF0000) /* 受信フレーム長 */
...
#define E25G_BANKNOS_LENGTH             (0x03FF0000) /* 受信フレーム長 */
