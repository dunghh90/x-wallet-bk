...
*     error status
********************************************************************/
status_t u_iana_hardware_init (
    const xmlChar *modname,
    const xmlChar *revision)
{
    status_t res = NO_ERR;
    ncx_module_t *iana_hardware_mod = NULL;

    iana_hardware_mod = ncx_find_module(modname, revision);
    if (iana_hardware_mod == NULL) {
...
} /* u_iana_hardware_init */

/********************************************************************
* FUNCTION u_iana_hardware_init2
*
...
*     error status
********************************************************************/
status_t u_iana_hardware_init2 (void)
{
    status_t res = NO_ERR;
...
} /* u_iana_hardware_init2 */

/********************************************************************
* FUNCTION u_iana_hardware_cleanup
*    cleanup the server instrumentation library
*
********************************************************************/
void u_iana_hardware_cleanup (void)
{
