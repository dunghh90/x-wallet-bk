...
static ncx_module_t *iana_hardware_mod;

/********************************************************************
* FUNCTION y_iana_hardware_init_static_vars
*
* initialize module static variables
*
********************************************************************/
static void y_iana_hardware_init_static_vars (void)
{
    iana_hardware_mod = NULL;

} /* y_iana_hardware_init_static_vars */
    ...
    const xmlChar *revision)
{
    ...
    if (xml_strcmp(modname, y_iana_hardware_M_iana_hardware)) {
        return ERR_NCX_UNKNOWN_MODULE;
    }

    if (revision && xml_strcmp(revision, y_iana_hardware_R_iana_hardware)) {
        return ERR_NCX_WRONG_VERSION;
    }


    res = ncxmod_load_module(
        y_iana_hardware_M_iana_hardware,
        y_iana_hardware_R_iana_hardware,
        agt_get_savedevQ(),
        &iana_hardware_mod);
    if (res != NO_ERR) {
        return res;
    ...
    res = u_iana_hardware_init(modname, revision);
    return res;

} /* y_iana_hardware_init */
...
*     error status
********************************************************************/
status_t y_iana_hardware_init2 (void)
{
    status_t res = NO_ERR;

    res = u_iana_hardware_init2();

    return res;

} /* y_iana_hardware_init2 */
...
*
********************************************************************/
void y_iana_hardware_cleanup (void)
{

    u_iana_hardware_cleanup();

} /* y_iana_hardware_cleanup */

/* END SIL-SA y_iana_hardware.c */
