...
*     error status
********************************************************************/
status_t u_iana_if_type_init (
    const xmlChar *modname,
    const xmlChar *revision)
{
    status_t res = NO_ERR;
    ncx_module_t *iana_if_type_mod = NULL;

    iana_if_type_mod = ncx_find_module(modname, revision);
    if (iana_if_type_mod == NULL) {
...
*     error status
********************************************************************/
status_t u_iana_if_type_init2 (void)
{
    status_t res = NO_ERR;
...
} /* u_iana_if_type_init2 */

/********************************************************************
* FUNCTION u_iana_if_type_cleanup
*    cleanup the server instrumentation library
*
********************************************************************/
void u_iana_if_type_cleanup (void)
{
