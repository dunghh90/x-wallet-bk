...
*     error status
********************************************************************/
status_t u_ietf_yang_types_init (
    const xmlChar *modname,
    const xmlChar *revision)
{
    status_t res = NO_ERR;
    ncx_module_t *ietf_yang_types_mod = NULL;

    ietf_yang_types_mod = ncx_find_module(modname, revision);
    if (ietf_yang_types_mod == NULL) {
...
*     error status
********************************************************************/
status_t u_ietf_yang_types_init2 (void)
{
    status_t res = NO_ERR;
...
*
********************************************************************/
void u_ietf_yang_types_cleanup (void)
{
...
/* END SIL-SA u_ietf_yang_types.c */
