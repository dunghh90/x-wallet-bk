...
static ncx_module_t *ietf_inet_types_mod;

/********************************************************************
* FUNCTION y_ietf_inet_types_init_static_vars
*
* initialize module static variables
*
********************************************************************/
static void y_ietf_inet_types_init_static_vars (void)
{
    ietf_inet_types_mod = NULL;

} /* y_ietf_inet_types_init_static_vars */
...
*     error status
********************************************************************/
status_t y_ietf_inet_types_init (
    ...
    const xmlChar *revision)
{
    ...
    if (xml_strcmp(modname, y_ietf_inet_types_M_ietf_inet_types)) {
        return ERR_NCX_UNKNOWN_MODULE;
    }

    if (revision && xml_strcmp(revision, y_ietf_inet_types_R_ietf_inet_types)) {
        return ERR_NCX_WRONG_VERSION;
    }


    res = ncxmod_load_module(
        y_ietf_inet_types_M_ietf_inet_types,
        y_ietf_inet_types_R_ietf_inet_types,
        agt_get_savedevQ(),
        &ietf_inet_types_mod);
    if (res != NO_ERR) {
        return res;
    ...
    res = u_ietf_inet_types_init(modname, revision);
    return res;

} /* y_ietf_inet_types_init */
...
*     error status
********************************************************************/
status_t y_ietf_inet_types_init2 (void)
{
    status_t res = NO_ERR;

    res = u_ietf_inet_types_init2();

    return res;

} /* y_ietf_inet_types_init2 */
...
*
********************************************************************/
void y_ietf_inet_types_cleanup (void)
{
...
/* END SIL-SA y_ietf_inet_types.c */
