 ...
 */
INT f_cmn_com_bootslot_s3g_get(T_RRH_SLOT_S3G *pOutData)
{
    UINT shm_num = (UINT)E_RRH_SHMID_APL_SLOT_S3G_BOOT;      /* 共有メモリナンバー */
    UINT sem_num = (UINT)E_RRH_SEMID_APL_SLOT_S3G_BOOT;      /* セマフォナンバー   */
 ...
 * @date    2016/02/25 TDI)satou 起動時集約用を使用するように
 */
INT f_cmn_com_bootslot_s3g_set(T_RRH_SLOT_S3G *pInData)
{
    UINT shm_num = (UINT)E_RRH_SHMID_APL_SLOT_S3G_BOOT;      /* 共有メモリナンバー */
    UINT sem_num = (UINT)E_RRH_SEMID_APL_SLOT_S3G_BOOT;      /* セマフォナンバー   */
