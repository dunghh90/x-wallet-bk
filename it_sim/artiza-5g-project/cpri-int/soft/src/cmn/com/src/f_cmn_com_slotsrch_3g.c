/*!
 * @skip  $ld:$
 * @file  f_cmn_com_slotsrch_3g.c
 * @brief スロット番号から何番スロットか抽出(3G) 16B KCN add
 ...
 */
INT f_cmn_com_slotsrch_3g(USHORT linkno, USHORT slotno, USHORT *slot_index)
{
    T_RRH_SLOT_3G_RE slot_info;

    f_cmn_com_slot_3g_get(linkno, &slot_info);
