 ...
 * @brief 共有メモリ取得/設定(カード状態(3G)(Slot単位))
 ...
 */
INT f_cmn_com_cardstslt_3g_get(USHORT linkno, USHORT slt_index, T_RRH_CARDST_3G *pOutData)
{
    UINT shm_num = (UINT)E_RRH_SHMID_APL_CARDST_SLOT_3G;     /* 共有メモリナンバー   */
    UINT sem_num = (UINT)E_RRH_SEMID_APL_CARDST_SLOT_3G;     /* セマフォナンバー     */
	UINT lnkOfs;
    UINT size;
    INT  ret;
    INT errcd;      /* BPFエラーコード */
 ...
 * @date    2016/10/04 KCN)hfuku create 16B機能追加
 */
INT f_cmn_com_cardstslt_3g_set(USHORT linkno, USHORT slt_index, T_RRH_CARDST_3G *pInData)
{
    UINT shm_num = (UINT)E_RRH_SHMID_APL_CARDST_SLOT_3G;     /* 共有メモリナンバー   */
    UINT sem_num = (UINT)E_RRH_SEMID_APL_CARDST_SLOT_3G;     /* セマフォナンバー     */
	UINT lnkOfs;
